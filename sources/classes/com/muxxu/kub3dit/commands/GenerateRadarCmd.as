package com.muxxu.kub3dit.commands {
	 ...
	 * Its responsability is to generate the radar view for map save.
	 *
	 * @author Francois
	 * @date 11 déc. 2011;
	 */
	public class GenerateRadarCmd extends AbstractCommand implements ProgressiveCommand {
		 ...
		 * CONSTRUCTOR *
		 * *********** */
		public function  GenerateRadarCmd(map:Map) {
			_map = map;
			_efTarget = new Shape();
		 ...
		 * @inheritDoc
		 */
		public function get done():Number { return _i/(_map.mapSizeX * _map.mapSizeY); }
		...
		private function enterFrameHandler(event:Event):void {
			...
			do{
				...
				if(tile > 0) {
					_bmd.setPixel32(px, py, 0xff000000 + _colors[tile][pz+1]);
				}
				_i++;
